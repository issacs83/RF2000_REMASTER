# 1 "tlv320aic32_aic32_opencodec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "tlv320aic32_aic32_opencodec.c" 2
...
# 9 "tlv320aic32_aic32_opencodec.c" 2
...
AIC32_Handle TLV320AIC32_openCodec( uint32_t id, uint8_t *config )
{
    ...
    if ( ( id != 0 ) || ( config == 0 ) )
        return -1;
# 49 "tlv320aic32_aic32_opencodec.c"
    aic32 = ( AIC32_Handle )0x18;
