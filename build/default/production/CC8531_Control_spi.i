    ...
    for(cmd_count = 22; cmd_count < 40; cmd_count++){
        ...
        if(cmd_count == 32){
            ...
            if(streaming_off_flag == 0x08){
                ...
                DELAY_milliseconds(1);
                I2C1_Write1ByteRegister( 0x18, 0x40, 0x0c );
                DELAY_milliseconds(1000);
                I2C1_Write1ByteRegister( 0x18, 0x00, 0x00 );
                DELAY_milliseconds(1);
                I2C1_Write1ByteRegister( 0x18, 0x40, 0x00 );
                DELAY_milliseconds(1);
                power_off_sequence();
            }
        }
# 393 "CC8531_Control_spi.c"
        DELAY_microseconds(1);
    }
    do { LATBbits.LATB0 = 1; } while(0);
